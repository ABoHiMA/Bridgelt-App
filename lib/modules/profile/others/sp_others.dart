...
class OthersSpecialNeedProfile extends StatelessWidget {
  const OthersSpecialNeedProfile({super.key});
                        ...
                        Column(
                          children: [
                            ...
                            txt(
                              context: context,
                              txt:
                                  'From: ${spModel.specialNeedGovernorate}, ${spModel.specialNeedCity}',
                              clr: wt,
                              isClr: true,
                              sz: 16,
                            ),
